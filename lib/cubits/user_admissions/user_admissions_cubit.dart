...
import 'user_admissions_state.dart';

class UserAdmissionsCubit extends Cubit<UserAdmissionsState> {
  final AdmissionsService _service;
  static const int _pageSize = 10;
  Timer? _debounceTimer;

  UserAdmissionsCubit(this._service) : super(const UserAdmissionsState());
