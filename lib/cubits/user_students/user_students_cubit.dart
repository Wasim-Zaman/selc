...
class UserStudentsCubit extends Cubit<UserStudentsState> {
  final EnrolledStudentsServices _service;
  static const int _pageSize = 10;
  Timer? _debounceTimer;

  UserStudentsCubit(this._service) : super(const UserStudentsState());
  ...
  Future<void> fetchPage(int page, {bool silent = false}) async {
    ...
    try {
      final result = await _service.getStudentsPaginated(
        page: page,
        pageSize: _pageSize,
